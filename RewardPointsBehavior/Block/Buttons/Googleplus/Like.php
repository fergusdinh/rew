...
namespace Lof\RewardPointsBehavior\Block\Buttons\Googleplus;
...
class Like extends \Lof\RewardPointsBehavior\Block\Buttons\AbstractButtons
{
	...
	{
		return $this->getUrl(Config::ROUTES . '/googleplus/like');
	}

	public function getUnlikeUrl()
	{
		return $this->getUrl(Config::ROUTES . '/googleplus/unlike');
	}
}