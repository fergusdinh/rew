 ...
 */
namespace Lof\RewardPoints\Block\Adminhtml\Import\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
         ...
         */
        if($this->_isAllowedAction('Lof_RewardPoints::import_rewardpoints')){
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Customer Points Import')]);
