...
namespace Lof\RewardPoints\Block\Adminhtml\Spending\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function addTabToForm($model, $fieldsetId = 'actions_fieldset', $formName = 'sales_rule_form')
    {
        ...
        $field->setRenderer($renderer);
//         /**
//         * Spend Max point for Percentage of Product price
//         */
//        $isElementDisabled = in_array('percentage_max_points', $param);
//        $field = $fieldset->addField(
//            'percentage_max_points',
//            'text',
//            [
//                'name'     => 'percentage_max_points',
//                'label'    => __('Point Limitation As Percentage Of Specific Product'),
//                'title'    => __('Point Limitation As Percentage Of Specific Product'),
//                'required' => false,
//                'style'    => 'width: 28rem;',
//                'disabled' => $isElementDisabled
//            ]
//        );
        $renderer = $element->setField('percentage_max_points')
        ->setData('is_scope_website', true);
        $field->setRenderer($renderer);
