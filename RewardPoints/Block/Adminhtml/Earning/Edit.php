...
namespace Lof\RewardPoints\Block\Adminhtml\Earning;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Lof_RewardPoints::earning')) {
            ...
            if($this->_coreRegistry && $this->_coreRegistry->registry('earning_rate')->getId() && !$this->getRequest()->getParam('store')){
                $this->buttonList->add(
                    'duplicate',
                    [
    ...
    public function getDeleteUrl()
    {
        ...
        return $this->getUrl('*/*/delete', [$this->_objectId => 0]);
    }
    ...
    {
        if ($this->_coreRegistry && $this->_coreRegistry->registry('earning_rate')->getId()) {
