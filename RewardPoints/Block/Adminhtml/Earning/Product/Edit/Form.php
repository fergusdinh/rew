...
namespace Lof\RewardPoints\Block\Adminhtml\Earning\Product\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _afterToHtml($html)
    {
        ...
        $html .= $this->getLayout()->createBlock('Lof\RewardPoints\Block\Adminhtml\Earning\Product\Grid')->setJsFormObject('edit_form')->toHtml();
