...
class ReferredEarningPointLabel extends \Magento\Ui\Component\Listing\Columns\Column
{
    /**
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['rule_id'])) {
                    ...
                    $item[$fieldName . '_html'] = $this->rewardsBalanceEarn->getPointLabel($item, $store_id, true);
                }
            }
        }
        return $dataSource;
