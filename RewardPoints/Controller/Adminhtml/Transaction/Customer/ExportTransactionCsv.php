...
class ExportTransactionCsv extends \Magento\Backend\App\Action
{
    /**
    ...
    public function execute()
    {
        ...
        $fileName = "lof_rewardpoints_customer{$id}_transaction_history.csv";
        $content = $this->_view->getLayout()->createBlock(
            'Lof\RewardPoints\Block\Adminhtml\Customer\Grid'
        )->setCustomerId($id)->getExcelFile(
            $fileName
        );
