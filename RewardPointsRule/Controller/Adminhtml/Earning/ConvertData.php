...
class ConvertData extends \Lof\RewardPoints\Controller\Adminhtml\Earning
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addSuccess(__('You converted earning serialized condition rules data to JSON data completely.'));
        } catch (\Magento\Framework\Exception\LocalizedException $e) {
            $this->messageManager->addError(
                __('Something went wrong while convert earning serialzied condition rules data to JSON data. Please review the error log.')
                );
