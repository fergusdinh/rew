...
class MassDelete extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Lof\RewardPointsRule\Model\ResourceModel\Spending\CollectionFactory $collectionFactory
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Lof_RewardPoints::spendingrule_delete');
    }
}
