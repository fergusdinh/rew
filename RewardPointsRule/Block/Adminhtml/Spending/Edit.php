...
namespace Lof\RewardPointsRule\Block\Adminhtml\Spending;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if($type)
        $this->buttonList->update('back', 'onclick', "setLocation('" . $this->getUrl('rewardpointsrule/spending/index/type/'. $type ) . "')");
    }
