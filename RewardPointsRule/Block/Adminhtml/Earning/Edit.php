...
namespace Lof\RewardPointsRule\Block\Adminhtml\Earning;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Lof_RewardPointsRule';
        $this->_controller = 'adminhtml_earning';

        parent::_construct();

        if ($this->_isAllowedAction('Lof_RewardPoints::earning')) {
        ...
        if ($this->_isAllowedAction('Lof_RewardPoints::earning') && !$this->getRequest()->getParam('store')) {
        ...
        if($type)
        $this->buttonList->update('back', 'onclick', "setLocation('" . $this->getUrl('rewardpointsrule/earning/index/type/'. $type ) . "')");
    }
    ...
    {
        return $this->getUrl('rewardpointsrule/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
