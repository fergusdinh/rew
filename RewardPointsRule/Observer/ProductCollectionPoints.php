...
class ProductCollectionPoints implements ObserverInterface
{
	/**
	...
	public function execute(\Magento\Framework\Event\Observer $observer)
	{
		if ($this->rewardsRuleConfig->isEnable()) {
			$obj        = $observer->getObj();
			$colleciton = $observer->getEvent()->getCollection(); 
			$products   = $this->rewardsBalanceEarn->getProductCollectionPoints($colleciton, $observer->getProducts());
